    ...
    function FiibotRatingsTwo(fiibot_stars, sender, two_stars) {
        var fiibotratings = null
            ...
            if (fiibotratings === null) {
                ...
                fs.writeFileSync('./database/fiibotratingsTwo.json',JSON.stringify(two_stars, null, 2));
            } else {
    ...
    function FiibotRatingsThree(fiibot_stars, sender, three_stars) {
        var fiibotratings = null
            ...
            if (fiibotratings === null) {
                ...
                fs.writeFileSync('./database/fiibotratingsThree.json',JSON.stringify(three_stars, null, 2));
            } else {
    ...
    function FiibotRatingsFour(fiibot_stars, sender, four_stars) {
        var fiibotratings = null
            ...
            if (fiibotratings === null) {
                ...
                fs.writeFileSync('./database/fiibotratingsFour.json',JSON.stringify(four_stars, null, 2));
            } else {
    ...
    function FiibotRatingsFive(fiibot_stars, sender, five_stars) {
        var fiibotratings = null
            ...
            if (fiibotratings === null) {
                ...
                fs.writeFileSync('./database/fiibotratingsFive.json',JSON.stringify(five_stars, null, 2));
            } else {
